...
def calc_wOBA_ranks(df=time_df,time_frame='Season',thresh=0.075):    
    thresh = thresh if df.shape[0] >= 60000 else thresh*1.5 if df.shape[0] >= 45000 else thresh*2 if df.shape[0] >= 30000 else thresh*3 if df.shape[0] >= 15000 else thresh*4
