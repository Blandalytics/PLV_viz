...
st.write('- __Swing Aggression__: How much more often a batter swings at pitches, given the swing likelihoods of the pitches they face.')
st.write('''
- __Strikezone Judgement__: The "correctness" of a batter's swings and takes, using the likelihood of a pitch being a called strike (for swings) or a ball/HBP (for takes).
''')
st.write("- __Decision Value__: The opportunity cost of a batter's swing decision, using the predicted outcomes for that pitch.")
st.write("- __Contact Ability__: A batter's ability to make contact (foul strike or BIP), above the contact expectation of each pitch.")
st.write("- __Adjusted Power__: Expected number of bases (aka SLG) above a pitch's expectation, for each BBE.")
st.write("- __Hitter Efficiency__: wOBA added by the batter to each pitch they see (including swing/take decisions), after accounting for pitch quality.")
