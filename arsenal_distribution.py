...
st.write('- ***Pitchtype PLA***: Predicted run value for that pitch type, per 100 thrown')
@st.cache
# Load Data
def pla_data(dataframe, year):
    ...
    season_df['pitchtype_pla'] = season_df['pitch_runs'].mul(100).div(season_df['pitch_id'])
